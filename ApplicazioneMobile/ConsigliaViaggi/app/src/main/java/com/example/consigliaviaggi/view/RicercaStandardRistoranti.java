...
public class RicercaStandardRistoranti extends Fragment implements PresenterToViewRicercaStruttura {
    private ListView listView;
    private RadioButton pizzeria, ristorante, altro, fastfood, star1, star2, star3, star4, star5;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        pizzeria = (RadioButton)rootView.findViewById(R.id.radiohotel);
        fastfood = (RadioButton)rootView.findViewById(R.id.radiobb);
        ristorante = (RadioButton)rootView.findViewById(R.id.radioapp);
        ...
        pizzeria.setOnClickListener(v -> {

            fastfood.setChecked(false);
            ristorante.setChecked(false);
            altro.setChecked(false);
            sottocategoria ="pizzeria";
            cercaButton.setEnabled(true);
        });

        ristorante.setOnClickListener(v -> {

            fastfood.setChecked(false);
            pizzeria.setChecked(false);
            altro.setChecked(false);
        ...
        cercaButton.setOnClickListener(view -> {
            if(gpsEnabled)
                presenter.research(luogoUtente,nome.getText().toString().trim(),
                        "ristoranti",sottocategoria,rating, prezzoda.getText().toString(), prezzoa.getText().toString());
            else
