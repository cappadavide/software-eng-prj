...
public class RicercaStandardAttrazioni extends Fragment implements PresenterToViewRicercaStruttura {

    private ListView listView;
    private RadioButton museo, parcogiochi, altro, zoo, star1, star2, star3, star4, star5;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(R.layout.activity_ricerca_standard_attrazioni, container, false);
        ...
        museo = (RadioButton) rootView.findViewById(R.id.radiohotel);
        zoo = (RadioButton) rootView.findViewById(R.id.radiobb);
        parcogiochi = (RadioButton) rootView.findViewById(R.id.radioapp);
        ...
        museo.setOnClickListener(v -> {

            zoo.setChecked(false);
            parcogiochi.setChecked(false);
            altro.setChecked(false);
            sottocategoria = "museo";
            cercaButton.setEnabled(true);
        });

        parcogiochi.setOnClickListener(v -> {

            zoo.setChecked(false);
            museo.setChecked(false);
            altro.setChecked(false);
            sottocategoria = "parcogiochi";
            cercaButton.setEnabled(true);
        });
        ...
        cercaButton.setOnClickListener(view -> {
            ...
            if(gpsEnabled)
                presenter.research(luogoUtente,nome.getText().toString().trim(),
                        "attrazioni",sottocategoria,rating, prezzoda.getText().toString(), prezzoa.getText().toString());
            else
